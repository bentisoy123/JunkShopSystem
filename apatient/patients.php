...
include 'aaside.php'; ?>
        ...
        <input type="hidden" name="date" required  class="form-control" value="<?php echo date('Y-m-d') ?>">
                                        ...
                                        <input type="text" name="names" required  class="form-control" placeholder="Enter the Name of the person you are registering">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                      ...
                                      <option selected value="">---Choose---</option>
                                       ...
                                       <option value="individual">Individual </option> 
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                  <input type="text" name="location" required  class="form-control" placeholder="Enter your address here">
 </div>
                                            </div>
                                        </div>
 <div class="row">
                                            ...
                                            <div class="col-md-10">
                <div class="form-group">
                                        <input type="number" name="contact" required  class="form-control" placeholder="Enter the contact Number">
                                                </div>
                                            </div>
                                        </div>
